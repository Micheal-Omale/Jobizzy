import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, toRef, isRef, computed, hasInjectionContext, inject, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, nextTick, mergeProps, getCurrentScope, toValue, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { L as parseURL, E as encodePath, M as decodePath, N as hasProtocol, O as isScriptProtocol, P as joinURL, w as withQuery, Q as sanitizeStatusCode, R as getContext, $ as $fetch, S as baseURL, T as defu, a as createError$1, U as hash, V as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./callback-Be6mnwp3.mjs')
  },
  {
    name: "find-jobs-id",
    path: "/find-jobs/:id()",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./_id_-BjqHDqTN.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./dashboard-DToUD0Ue.mjs')
  },
  {
    name: "find-jobs",
    path: "/find-jobs",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./index-BVzUbEA7.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./login-CHIc0lUA.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./profile-VQejuXsT.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-DSS3TLDO.mjs')
  }
];
...
const vue_plugin_qbtsNkphPyvFVqysDjTUbOhZwXppYZX43VAeauBYxl4 = /* @__PURE__ */ defineNuxtPlugin({
  name: "posthog-client",
  setup(nuxtApp) {
    const runtimeConfig = /* @__PURE__ */ useRuntimeConfig();
    runtimeConfig.public.posthog;
    runtimeConfig.public.posthogClientConfig;
    {
      return;
    }
  }
...
const plugins = [
  ...
  vue_plugin_qbtsNkphPyvFVqysDjTUbOhZwXppYZX43VAeauBYxl4
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-B-S9mRLh.mjs').then((m) => m.default || m))
};
...
function useTheme() {
  const theme = useState("jobizzy-theme", () => "light");
  function set(value) {
    theme.value = value;
  }
  function toggle() {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D-2p_mKW.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dr_4sjlB.mjs'));
...
export { __nuxt_component_1$1 as _, useState as a, useNuxtApp as b, useRuntimeConfig as c, useTheme as d, entry_default as default, useRouter as e, encodeRoutePath as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, useRoute as u };
